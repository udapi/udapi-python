...
class Past(udapi.block.msf.phrase.Phrase):
	...
	def process_node(self, node):
		...
		# compound past tense
		if (node.feats['VerbForm'] in ['Part', 'PartRes', 'Fin']) and node.upos == 'VERB' and node.feats['Voice'] != 'Pass' and node.feats['Mood'] not in ['Imp', 'Cnd'] and node.feats['Tense'] in past_tenses:
